...
|---|---|---|
| §2 backend selection, timing, reproducibility record, profiling regions | dispatched 2026-09-17 (openai-sol) | — |
| §3 fixed comparison suite (`bench/perf_campaign.py`) | dispatched 2026-09-17 (openai-terra, chained) | — |
