...
def test_the_old_train_lets_a_fast_latch_through():
    # the 3 x 0.75 train of 2026-09-19 and before, against a +20 % / -0.8 mV loop (38 steps)
...
def test_a_killed_rail_reloads_150_ms_later():
    ...
    topo = net.topology()
    perturb = [(1.0, 0.0), (1.16, -0.8), (0.9, 0.8)]
