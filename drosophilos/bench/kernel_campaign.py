...
def main(argv=None):
    ...
    rec = {"block": a.block, "datapath": pl.datapath, "backend": a.backend,
           ...
           "kill_train": [control.KILL_PULSES, control.KILL_STRENGTH], "powerup_veto": True, "commit_reignite": True, "true_guards": True, "retry_clear": False, "start_relight_hops": 5, "request_clear_pulses": 4,
