...
(653 neurons) -- beside the latch-register adder (594 neurons) it replaces, on real MCNS at
...
def run_one(storage: str, m: MCNS, n_cases: int, restarts: int, time_limit_s: float, conditions: str,
    ...
    out = {"storage": storage, "neurons": net.n, "synapses": len(net.src), "placement": pl.summary(net),
